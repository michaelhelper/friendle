...
function get_user_data(){
    fetch("../apis/user_data.php")
        ...
        .then(data => {
            ...
            document.getElementById("total_wordles").innerHTML = "Total Wordles: " + totalWordles;
            document.getElementById("total_wordles_completed").innerHTML = "Total Wordles Completed: " + totalWordlesCompleted;
            document.getElementById("total_score").innerHTML = "Total Score: " + totalScore;
            document.getElementById("average_score").innerHTML = "Average Score: " + averageScore;
        })
        .catch(error => {
            console.error("Error:", error);
        });
