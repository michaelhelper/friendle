    ...
    fetch("../apis/user_data.php")
        ...
        .then(data => {
            ...
            if (lastWordleNumber == day) {
                ...
                enter_wordle.classList.add("relative", "flex", "justify-center", "items-center", "gap-[5px]", "pt-[15px]");
                ...
                shareStatement.classList.add( "h-[25px]", "mt-[12px]", "pl-[10px]", "pr-[10px]", "relative", "flex", "justify-center", "items-center", "text-center", "text-white", "text-md", "font-bold", "font-['Inter']", "bg-[#498245]");
