...
function share_friendle() {
    fetch('/api/checkFriendlePlayed')
        .then(response => response.json())
        .then(data => {
            if (data.hasPlayed) {
                // Player has played the friendle
                console.log('Player has played the friendle');
            } else {
                // Player has not played the friendle
                console.log('Player has not played the friendle');
            }
        })
        .catch(error => {
            console.error('Error:', error);
