...
<html>
  ...
  <body class="flex justify-center bg-white dark:bg-black">
    <div id="screen" class="w-[393px] h-[852px] relative">
      ...
      <textarea id="wordle" class="w-[200px] h-[125px] left-[93px] top-[148px]  relative bg-[#AC9534] bg-opacity-30 text-sm text-center dark:text-white" placeholder="Enter Today's Worldle Results"></textarea>
      <div class="w-[46px] h-[25px] left-[170px] top-[285px]  relative">
      ...
      <div class="left-[7px] top-[511px]  relative justify-start items-start gap-2.5 inline-flex">
