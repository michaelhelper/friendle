  ...
  <body class="flex justify-center bg-white dark:bg-black">
    <div class="w-[393px] h-[852px] relative">
      ...
      <div class="left-[7px] top-[333px] absolute justify-start items-start gap-1.5 inline-flex">
        ...
        <div class="w-[130px] h-[25px] pl-[25px] pt-[10px] relative">
          <div class="w-[130px] h-[25px] top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#AC9534]">10 Day STREAK</div>
        </div>
      </div>
      <!--Average Score-->
