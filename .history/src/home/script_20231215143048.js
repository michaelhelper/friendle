...
function change_email_preferences(friend_username) {
    let email_notification = document.getElementById("email_notification:checked").value;
    var email_notification = document.querySelector('.email_notification:checked').value;
