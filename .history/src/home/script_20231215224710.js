    ...
    fetch("../apis/friend_requests.php", {
        ...
        .then(data => {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                acceptButton.classList.add("pl-[10px]" ,"pr-[10px]", "h-[25px]", "relative", "flex", "justify-center", "items-center", "text-center", "text-white", "text-xs", "font-bold", "font-['Inter']", "bg-[#498245]");
                ...
                rejectButton.classList.add("pl-[10px]", "pr-[10px]", "h-[25px]", "relative", "flex", "justify-center", "items-center", "text-center", "text-white", "text-lg", "font-bold", "font-['Inter']", "bg-[#AC9534]");
