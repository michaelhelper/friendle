    ...
    fetch("../apis/user_data.php")
        ...
        .then(data => {
            ...
            if (lastWordleNumber == day) {
                ...
                // add a button for each friend to share the wordle with them individually do two friends per row
                ...
                //     let friendButtonsContainer = document.getElementById("enter_wordle");
                //     // loop through each friend
                //     for (let i = 0; i < data.length; i++) {
                //         friend = data[i]; // assign the current friend
                //         let friendButton = document.createElement("button");
                //         friendButton.innerHTML = "Share with " + friend;
                //         friendButton.classList.add("friend-button");
                //         friendButton.onclick = function () {
                //             Share_wordle(0, data[data.length - 1]["wordle_number"], data[data.length - 1]["wordle_score"], data[data.length - 1]["wordle"]);
                //         }
                //         friendButtonsContainer.appendChild(friendButton);
                //     }
