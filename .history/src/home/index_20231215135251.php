  ...
  <body class="flex justify-center bg-white dark:bg-black">
    <div id="screen" class="w-[393px] h-[852px] relative">
      ...
      <div class="pl-[10px] pt-[15px] relative justify-start items-start gap-[5px] inline-flex">
        ...
        <div id="email_preferences" class="w-[130px] h-[25px]  relative flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#498245]">Email Notifications</div>
