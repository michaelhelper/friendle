        ...
        .then(data => {
            ...
            if (lastWordleNumber == day) {
                ...
                shareButton.onclick = function () {
                    //make a share popup on the screen
                    let sharePopup = document.createElement("div");
                    sharePopup.classList.add("fixed", "top-1/2", "left-1/2", "transform", "-translate-x-1/2", "-translate-y-1/2", "bg-white", "rounded-xl", "shadow-xl", "p-4", "flex", "flex-col", "justify-center", "items-center", "gap-2");
