...
function handle_friend_request(action, friend) {
    ...
    const acceptButton = document.getElementById(friend + "1");
    const rejectButton = document.getElementById(friend + "2");
    const friendName = document.getElementById(friend + "3");
    if (friendElement) {
