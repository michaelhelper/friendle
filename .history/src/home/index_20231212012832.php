    ...
    <div class="w-[393px] h-[852px] relative">
      ...
      <div class="left-[7px] top-[455px] absolute justify-start items-start gap-3 inline-flex">
        ...
        <div class="w-[29px] h-[25px] relative">
          <div id="total_wordles_played" class="w-[29px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#AC9534]">69</div>
        </div>
      </div>
