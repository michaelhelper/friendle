    ...
    fetch("../apis/user_data.php")
        ...
        .then(data => {
            ...
            if (lastWordleNumber == day) {
                ...
                let wordle_number = document.createElement("div");
                wordle_number.innerHTML = "Wordle" + data[data.length - 1]["wordle_number"];
                wordle_number.innerHTML = "Score: " + data[data.length - 1]["wordle_score"] + "/6";
                wordle_number.classList.add("h-[25px]", "mt-[12px]", "pl-[10px]", "pr-[10px]", "relative", "flex", "justify-center", "items-center", "text-center", "text-white", "text-md", "font-bold", "font-['Inter']", "bg-[#498245]", "mx-auto");
                let wordle_score = document.createElement("div");
                wordle_score.innerHTML = "Wordle Score: " + data[data.length - 1]["wordle_score"] + "/6";
                wordle_score.classList.add("h-[25px]", "mt-[12px]", "pl-[10px]", "pr-[10px]", "relative", "flex", "justify-center", "items-center", "text-center", "text-white", "text-md", "font-bold", "font-['Inter']", "bg-[#498245]", "mx-auto");
                let wordle = document.createElement("div");
                wordle.innerHTML = "Wordle: " + data[data.length - 1]["wordle"];
                wordle.classList.add("h-[25px]", "mt-[12px]", "pl-[10px]", "pr-[10px]", "relative", "flex", "justify-center", "items-center", "text-center", "text-white", "text-md", "font-bold", "font-['Inter']", "bg-[#498245]", "mx-auto");
                ...
                enter_wordle.appendChild(wordle_number);
                enter_wordle.appendChild(wordle_score);
