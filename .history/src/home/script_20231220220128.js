    ...
    fetch("../apis/user_data.php")
        ...
        .then(data => {
            ...
            if (lastWordleNumber == day) {
                ...
                shareButton.innerHTML = "Share with Friends<img src='../../resources/share.png' alt='share' class='w-[25px] h-[25px] relative flex justify-center items-center text-center text-white text-md font-bold font-['Inter'] bg-white mx-auto'>";
                ...
                shareButton.onclick = function () {
                    Share_wordle(0, data[data.length - 1]["wordle_number"], data[data.length - 1]["wo`rdle_score"], data[data.length - 1]["wordle"]);
                }
