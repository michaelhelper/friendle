    ...
    <div class="w-[393px] h-[852px] relative">
      ...
      <div class="left-[44px] top-[64px] absolute justify-start items-start gap-[7px] inline-flex">
        ...
        <div class="w-[85px] h-[27px] relative">
          <button class="w-[85px] h-[27px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-base font-bold font-['Inter'] bg-[#AC9534] onclick">Sign Out</button>
        </div>
