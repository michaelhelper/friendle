    ...
    <div class="w-[393px] h-[852px] relative">
      ...
      <div class="left-[7px] top-[399px] absolute justify-start items-start gap-[9px] inline-flex">
        ...
        <div class="w-[29px] h-[25px] relative">
          <div class="w-[150px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#AC9534]">STREAK</div>
        </div>
      </div>
      <!--Wordles Played-->
