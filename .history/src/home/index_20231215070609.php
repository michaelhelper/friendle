  ...
  <body class="flex justify-center bg-white dark:bg-black">
    <div id="screen" class="w-[393px] h-[852px] relative">
      ...
      <div class="left-[7px] top-[633px] absolute justify-start items-start gap-[5px] inline-flex">
        ...
        <div class="w-[135px] h-[25px] relative">
          <div class="w-[135px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#498245]">Email Notifications</div>
        </div>
        <div class="w-[68px] h-[25px] relative">
          <div class="w-[225px] h-[25px] left-0 top-0 absolute flex justify-center items-center">
            <label class="switch">
                <input type="checkbox">
