    ...
    fetch("../apis/friend_requests.php", {
        ...
        .then(data => {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                friend_request.classList.add("pl-[10px]", "pt-[5px]", "pb-[10px]", "relative", "justify-start", "items-start", "gap-2.5", "flex");
                ...
                .then(user_data => {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        if (user_has_played && friend_has_played) {
                            ...
                            friendDiv.classList.add("pl-[10px]", "pt-[30px]", "relative", "justify-start", "items-start", "gap-2.5", "inline-flex");
                            ...
                            resultsDiv.classList.add("pl-[10px]", "pt-[15px]", "relative", "justify-start", "items-start", "gap-2.5", "inline-flex");
                            ...
                            headToHeadDiv.classList.add("pl-[10px]", "pt-[15px]", "relative", "justify-start", "items-start", "gap-2.5", "inline-flex");
