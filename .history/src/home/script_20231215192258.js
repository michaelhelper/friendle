    ...
    fetch("../apis/friend_requests.php", {
        ...
        .then(data => {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                rejectButton.classList.add("w-[25px]", "h-[25px]", "relative", "flex", "justify-center", "items-center", "text-center", "text-white", "text-xs", "font-bold", "font-['Inter']", "bg-[#AC9534]");
                // onclick="handle_friend_request(\'deny\', this.id)
