    ...
    //check if user has already played the wordle. If they have delete the box to enter the wordle and 
}
    ...
    fetch("../apis/user_data.php")
        ...
        .then(data => {
            ...
            data = JSON.parse(data);
                ...
                if (lastWordleNumber > most_recent_wordle) {
                    most_recent_wordle = lastWordleNumber;
                }
                totalWordles++;
            }
            if (most_recent_wordle !=)
