<?php
  ...
  $conn = mysqli_connect("localhost", "root", "", "wordle");
  if(!$conn) {
  ...
  $user_id = $row['user_id'];
  $sql = "SELECT * FROM wordles WHERE user_id='$user_id'";
  $result = mysqli_query($conn, $sql);
  $wordles = mysqli_fetch_all($result, MYSQLI_ASSOC);
...
<html>
  ...
  <body class="flex justify-center bg-white dark:bg-black">
    <div class="w-[393px] h-[852px] relative">
      <!--Title On Screen-->
      ...
      <div class="left-[44px] top-[64px] absolute justify-start items-start gap-[7px] inline-flex">
        <div class="w-[109px] h-[27px] relative">
          <div class="w-[109px] h-[27px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-base font-bold font-['Inter'] bg-[#AC9534]">Hello, User1</div>
        </div>
        <div class="w-[85px] h-[27px] relative">
          <button class="w-[85px] h-[27px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-base font-bold font-['Inter'] bg-[#AC9534]">Sign Out</button>
        </div>
      ...
      <textarea class="w-[200px] h-[125px] left-[93px] top-[148px] absolute bg-[#AC9534] bg-opacity-30 text-sm text-center dark:text-white" placeholder="Enter Today's Worldle Results"></textarea>
      <div class="w-[46px] h-[25px] left-[170px] top-[285px] absolute">
        <button class="w-[46px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-sm font-bold font-['Inter'] bg-[#498245]">Enter</button>
      </div>
      <!--Stats-->
      ...
      <div class="left-[7px] top-[399px] absolute justify-start items-start gap-[9px] inline-flex">
        ...
        <div class="w-9 h-[25px] relative">
          <div class="w-9 h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#498245]">4.21</div>
        </div>
      </div>
      <!--Wordles Played-->
      <div class="left-[7px] top-[455px] absolute justify-start items-start gap-3 inline-flex">
        ...
        <div class="w-[29px] h-[25px] relative">
          <div class="w-[29px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#AC9534]">69</div>
        </div>
      </div>
      ...
      <div class="left-[7px] top-[511px] absolute justify-start items-start gap-2.5 inline-flex">
        ...
        <div class="w-9 h-[25px] relative">
          <div class="w-9 h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#498245]">79%</div>
        </div>
      </div>
      <!--Friends-->
      ...
      <div class="left-[7px] top-[769px] absolute justify-start items-start gap-2 inline-flex">
        <div class="w-[77px] h-[25px] relative">
          <button class="w-[77px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#AC9534]">Add Friend</button>
        </div>
        <div class="w-[167px] h-[25px] relative">
          <input class="w-[167px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center dark:text-white bg-opacity-30 text-xs font-bold font-['Inter'] bg-[#AC9534]" placeholder="Enter Username Here"></input>
        </div>
      </div>
      <!--Friend Requests-->
      <div class="left-[7px] top-[812px] absolute justify-start items-start gap-[7px] inline-flex">
        <div class="w-[77px] h-[25px] relative">
          <div class="w-[77px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#498245]">User1</div>
        </div>
        <div class="w-[25px] h-[25px] relative">
          <button class="w-[25px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#498245]">✓</button>
        </div>
        <div class="w-[25px] h-[25px] relative">
          <button class="w-[25px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#AC9534]">x</button>
        </div>
      </div>
    </div>
  </body>
