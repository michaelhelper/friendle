...
<html>
  ...
  <body class="flex justify-center bg-white dark:bg-black">
    <div id="screen" class="w-[393px] h-[852px] relative">
      ...
      <button id='add_worclass="w-[46px] h-[25px] mt-[12px] mx-auto relative flex justify-center items-center text-center text-white text-sm font-bold font-['Inter'] bg-[#498245]" onclick="add_wordle()">Enter</button>
      <!--Stats-->
