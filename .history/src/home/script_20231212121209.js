    ...
    fetch("../apis/friend_requests.php", {
        ...
        .then(data => {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                friend_request.className = "left-[7px] top-[812px] absolute justify-start items-start gap-[7px] inline-flex";
                
                // create the inner elements
                let friendName = document.createElement("div");
                friendName.className = "w-[77px] h-[25px] relative";
                friendName.innerHTML = `<div class="w-[77px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#498245]">${data[i][]}</div>`;
                
                let acceptButton = document.createElement("button");
                acceptButton.className = "w-[25px] h-[25px] relative";
                acceptButton.innerHTML = `<button class="w-[25px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#498245]">✓</button>`;
                
                let rejectButton = document.createElement("button");
                rejectButton.className = "w-[25px] h-[25px] relative";
                rejectButton.innerHTML = `<button class="w-[25px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#AC9534]">x</button>`;
