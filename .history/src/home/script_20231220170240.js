    ...
    fetch("../apis/user_data.php")
        ...
        .then(data => {
            ...
            if (lastWordleNumber == day) {
                ...
                shareButton.classList.add("w-[50px]", "h-[25px]", "mt-[12px]", "pl-[10px]", "pr-[10px]", "relative", "flex", "justify-center", "items-center", "text-center", "text-white", "text-md", "font-bold", "font-['Inter']", "bg-[#498245]", "hover:bg-white", "mx-auto");
