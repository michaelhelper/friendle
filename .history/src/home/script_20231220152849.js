    ...
    fetch("../apis/user_data.php")
        ...
        .then(data => {
            ...
            if (lastWordleNumber == day) {
                ...
                enter_wordle.classList.add("pl-[10px]", "pt-[5px]", "pb-[10px]", "relative", "justify-start", "items-start", "gap-1.5", "flex");
                ...
                shareButton.classList.add("w-[50px]", "h-[25px]", "relative", "flex", "justify-center", "items-center", "text-center", "text-white", "text-lg", "font-bold", "font-['Inter']", "bg-[#498245]");
                // shareButton.onclick = function () {
                //     share_wordle();
                // };
                // add the share button to the enter_wordle div
