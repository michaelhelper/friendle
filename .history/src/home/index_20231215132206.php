...
<html>
  ...
  <body class="flex justify-center bg-white dark:bg-black">
    <div id="screen" class="w-[393px] h-[852px] relative">
      ...
      <!--Wordles Played-->
      <div class="pl-[10px] pt-[12px] relative justify-start items-start gap-[9px] inline-flex">
      <div class="left-[7px] top-[455px]  justify-start items-start gap-3 inline-flex">
        <div class="w-[138px] h-[25px] relative">
          <div class="w-[138px] h-[25px]       <div class="pl-[10px] pt-[12px] relative justify-start items-start gap-[9px] inline-flex">
 flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#AC9534]">Total Wordles Played</div>
        </div>
