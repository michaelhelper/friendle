    ...
    fetch("../apis/user_data.php")
        ...
        .then(data => {
            ...
            if (lastWordleNumber == day) {
                ...
                shareButton.innerHTML = "Share with Friends<img src='../../resources/share.png' alt='share' class='w-[25px] h-[25px] relative flex justify-center items-center text-center text-white text-md font-bold font-['Inter'] bg-[#498245] mx-auto hover:bg-white'>";
