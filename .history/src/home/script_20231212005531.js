    ...
    fetch("../apis/user_data.php")
        ...
        .then(data => {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                if (data[i]["wordle_score"] == parseInt(data[i]["wordle_score"])) {
                    consol
            ...
            alert ("Average Score: " + totalScore/totalWordlesCompleted + "\n" + "Total Wordles Completed: " + totalWordlesCompleted + "\n" + "Total Wordles: " + totalWordles);
        })
        .catch(error => {
            console.error("Error:", error);
        });
