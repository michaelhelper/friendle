    ...
    <div class="w-[393px] h-[852px] relative">
      ...
      <div class="left-[7px] top-[399px] absolute justify-start items-start gap-[9px] inline-flex">
        ...
        <div class="w-9 h-[25px] relative">
          <div id= "average_score" class="w-9 h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#498245]">4.21</div>
        </div>
      </div>
      <!--Wordles Played-->
      <div class="left-[7px] top-[455px] absolute justify-start items-start gap-3 inline-flex">
        ...
        <div class="w-[29px] h-[25px] relative">
          <div id="total_wordles_completed" class="w-[29px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#AC9534]">69</div>
        </div>
      </div>
      ...
      <div class="left-[7px] top-[511px] absolute justify-start items-start gap-2.5 inline-flex">
        ...
        <div class="w-9 h-[25px] relative">
          <div id="completion_percentage" class="w-9 h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#498245]">79%</div>
        </div>
      </div>
      <!--Friends-->
