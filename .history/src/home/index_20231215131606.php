...
<html>
  ...
  <body class="flex justify-center bg-white dark:bg-black">
    <div id="screen" class="w-[393px] h-[852px] relative">
      ...
      <!--Stats-->
      <div class="left-[7px] top-[333px] relative justify-start items-start gap-1.5 inline-flex">
        ...
        <div class="w-[130px] h-[35px] pl-[25px] relative">
          <div id="streak" class="w-[130px] h-[35px]  relative flex justify-center items-center text-center text-white text-md font-bold font-['Inter'] bg-[#AC9534]">0 Day STREAK</div>
        </div>
      </div>
      <!--Average Score-->
