...
<html>
  ...
  <body class="flex justify-center bg-white dark:bg-black">
    <div class="w-[393px] h-[852px] relative">
      ...
      <textarea id=class="w-[200px] h-[125px] left-[93px] top-[148px] absolute bg-[#AC9534] bg-opacity-30 text-sm text-center dark:text-white" placeholder="Enter Today's Worldle Results"></textarea>
