...
<html>
  ...
  <body class="flex justify-center bg-white dark:bg-black">
    <div id="screen" class="w-[393px] h-[852px] relative">
      ...
      <!--Wordles Played-->
      <div class="pl-[10px] pt-[15px] relative justify-start items-start gap-2.5 flex">
      ...
      <div class="pl-[10px] pb-[10px] pt-[30px] relative justify-start items-start gap-2.5 inline-flex">
        ...
        <input id="friend" class="pl-[10px] pr-[10px] h-[25px]  relative flex justify-center items-center text-center dark:text-white bg-opacity-30 text-xs font-bold font-['Inter'] bg-[#AC9534]" placeholder="Enter Username Here">
      </div>
      <!--Friend Requests-->
    </div>
  </body>
