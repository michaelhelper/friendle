    ...
    fetch("../apis/user_data.php")
        ...
        .then(data => {
            ...
            if (lastWordleNumber == day) {
                ...
                shareStatement.classList.add( "h-[25px]", "mt-[12px]", "margin-left-right-10", "relative", "flex", "justify-center", "items-center", "text-center", "text-white", "text-md", "font-bold", "font-['Inter']", "bg-[#498245]");
                // add padding and margin to the share statement
                shareStatement.style.padding = "10px";
