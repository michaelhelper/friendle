    ...
    <div class="w-[393px] h-[852px] relative">
      ...
      <div class="left-[7px] top-[769px] absolute justify-start items-start gap-2 inline-flex">
        ...
        <div class="w-[167px] h-[25px] relative">
          <input id=" class="w-[167px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center dark:text-white bg-opacity-30 text-xs font-bold font-['Inter'] bg-[#AC9534]" placeholder="Enter Username Here"></input>
        </div>
      </div>
      <!--Friend Requests-->
