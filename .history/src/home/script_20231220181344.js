        ...
        .then(data => {
            ...
            if (lastWordleNumber == day) {
                ...
                shareButton.onclick = function () {
                    // Create the share popup element
                    ...
                    // Add friends to the list (replace with your own logic to fetch and populate the list)
                    ...
                    // Add the friends list to the share popup
                    sharePopup.appendChild(friendsList);

                    // Append the share popup to the document body
