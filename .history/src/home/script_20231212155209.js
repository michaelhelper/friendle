    ...
    fetch("../apis/friend_requests.php", {
        ...
        .then(data => {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                acceptButton.innerHTML = '<button style="width: 25px; height: 25px; left: 0; top: 0; position: absolute; display: flex; justify-content: center; align-items: center; text-align: center; color: white; font-size: 12px; font-weight: bold; font-family: \'Inter\'; background-color: #498245;" onclick="handle_friend_request(\'accept\', this.id)">✓</button>';

                let rejectButton = document.createElement("button");
                rejectButton.style.cssText = "width: 25px; height: 25px; position: relative";
                // rejectButton.id = data[i]["username"] + "5";
                rejectButton.innerHTML = '<button style="width: 25px; height: 25px; left: 0; top: 0; position: absolute; display: flex; justify-content: center; align-items: center; text-align: center; color: white; font-size: 12px; font-weight: bold; font-family: \'Inter\'; background-color: #AC9534;" onclick="handle_friend_request(\'deny\', this.id)">x</button>';
