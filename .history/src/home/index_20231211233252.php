  ...
  <body class="flex justify-center bg-white dark:bg-black">
    <div class="w-[393px] h-[852px] relative">
      ...
      <div class="w-[46px] h-[25px] left-[170px] top-[285px] absolute">
        <button class="w-[46px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-sm font-bold font-['Inter'] bg-[#498245]" onclick>Enter</button>
      </div>
      <!--Stats-->
