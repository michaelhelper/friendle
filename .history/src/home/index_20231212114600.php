  ...
  <body class="flex justify-center bg-white dark:bg-black">
    <div class="w-[393px] h-[852px] relative">
      ...
      <div class="left-[7px] top-[769px] absolute justify-start items-start gap-2 inline-flex">
        <div class="w-[77px] h-[25px] relative">
          <button class="w-[77px] h-[25px] left-0 top-0 absolute flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#AC9534]" on>Add Friend</button>
        </div>
