...
function Share_wordle(phoneNumber, wordleNumber, score, wordle) {wordle 914 X/6
...
Your Turn: Friendle.comconsol
    // parse the wordle into a string
    wordle = wordle.replaceAll("\\r", "");
    wordle = wordle.split("\\n");
    wordle = wordle.join("\n");
