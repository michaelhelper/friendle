...
<html>
  ...
  <body class="flex justify-center bg-white dark:bg-black">
    <div id="screen" class="w-[393px] h-[852px] relative">
      ...
      <button id='add_wordle' class="w-[46px] h-[25px] mt-[12px] mx-auto relative flex justify-center items-center text-center text-white text-sm font-bold font-['Inter'] bg-[#498245]" onclick="add_wordle()">Enter</button>
      <!--Stats-->
      <div class="pt-[30px] pl-[10px] relative justify-start items-start gap-1.5 flex">
        ...
        <div class="w-[35px] h-[35px] relative flex justify-center items-center text-center text-white text-lg font-bold font-['Inter'] bg-[#AC9534]">T</div>
        <div class="w-[35px] h-[35px] relative flex justify-center items-center text-center text-white text-lg font-bold font-['Inter'] bg-[#498245]">S</div>
        <div id="streak" class="h-[35px] ml-[20px] relative flex justify-center items-center text-center text-white text-lg font-bold font-['Inter'] bg-[#AC9534]">0 Day STREAK</div>
      </div>
      <!--Average Score-->
...
pl        <div id="total_wordles_played" class="w-[29px] h-[25px] relative flex justify-center items-center text-center text-white text-xs font-bold font-['Inter'] bg-[#AC9534]">NA</div>
      </div>
