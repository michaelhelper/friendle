    ...
    fetch("../apis/user_data.php")
        ...
        .then(data => {
            ...
            if (lastWordleNumber == day) {
                ...
                shareButton.innerHTML = "Today's Wordle results have been added";
                shareButton.classList.add( "h-[25px]", "mt-[12px]", "pl-[10px]", "pr-[10px]", "relative", "flex", "justify-center", "items-center", "text-center", "text-white", "text-lg", "font-bold", "font-['Inter']", "bg-[#498245]");
