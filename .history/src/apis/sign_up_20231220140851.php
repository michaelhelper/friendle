...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // check the length of the password it must be at least 8 characters and have a number and a special character and a 
    if (strlen($_POST['password']) < 8 || !preg_match('/[0-9]/', $_POST['password']) || !preg_match('/[^A-Za-z0-9\-]/', $_POST['password'])) {
        echo "<script type='text/javascript'>alert('Password must be at least 8 characters and have a number and a special character');</script>";
        exit;
    }
