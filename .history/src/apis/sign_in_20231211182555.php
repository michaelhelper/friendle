...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $host = "localhost";
  $dbname = "friendle"; // Replace "friendle" with a valid word or check if it is a valid word in the context of the application
  $username = "root";
  $password = "";
  ...
  if ($result) {
    ...
    if ($hashedPassword === $enteredPasswordHash) {
      ...
      header('Location: /friendle/src/home'); // Replace "friendle" with a valid word or check if it is a valid word in the context of the application
    } else {
