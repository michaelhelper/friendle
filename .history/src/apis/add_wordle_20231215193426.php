...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $current_wordle_day = mysqli_real_escape_string($conn, $_POST['current_wordle_day']);
    $user_id = $_COOKIE['user_id'];
    // check if wordle is from today
    if ($current_wordle_day != $wordle_number) {
        echo "Wordle is not from today";
    }
