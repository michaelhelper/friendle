    ...
    if ($result) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            while ($wordle_row = mysqli_fetch_assoc($wordles_result)) {
                $wordle = array(
                    "wordle_number" => $wordle_row['iwordle_numberd'],
                    "wordle_name" => $wordle_row['wordle_name'],
                    "wordle_description" => $wordle_row['wordle_description'],
                    "wordle_words" => $wordle_row['wordle_words']
                );
