...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $create_wordles_table_query = "CREATE TABLE $wordles_table_name (id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY, wordle_number INT(6) NOT NULL, wordle_name VARCHAR(255) NOT NULL)";
