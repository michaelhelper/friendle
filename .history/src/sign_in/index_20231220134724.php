  ...
  <body class="flex justify-center bg-white dark:bg-black">
    <div class="w-[393px] h-[852px] relative bg-white">
      ...
      <div class="pt-[45px] relative justify-center items-center gap-1.5 flex">
        ...
        <div class="w-[47.85px] h-[45px] relative flex justify-center items-center text-center text-white text-xl font-bold font-['Inter'] bg-[#AC9534]">I</div>
        <div class="w-[47.85px] h-[45px] relative flex justify-center items-center text-center text-white text-xl font-bold font-['Inter'] bg-[#498245]">N</div>
      </div>
      <!--Username-->
      ...
      <div class="pt-[45px] relative justify-center items-center gap-[150px] flex">
          <button class="w-[82px] h-[35px] left-0 top-0 relative flex justify-center items-center text-center text-white text-sm font-bold font-['Inter'] bg-[#498245]" id="loginBtn" onclick="callSignInWithInputValues()">Log in</button>
          <button class="w-[82px] h-[35px] left-0 top-0 relative flex justify-center items-center text-center text-white text-sm font-bold font-['Inter'] opacity-75 bg-[#498245]" onclick="sign_up()">Sign Up</button>
      </div>
    </div>
  </body>
</html>